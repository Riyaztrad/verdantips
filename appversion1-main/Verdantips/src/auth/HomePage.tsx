...
export default class HomePage extends React.Component<HomePageProps, {}> {
  ...
  async share() {
    try {
      const res=Share.share({
        title: "App link",
        message: `Want to find restaurants doing their part for the planet? Now you can use the Verdantips app! Download it on the PlayStore here: https://bit.ly/verdantips_android, Download it on the Appstore: https://bit.ly/verdantips_ios`,//, Apple Store: ${appleLink}
  ...
  async componentDidMount() {
    ...
    console.log("this.filteredRestaurantList", this.filteredRestaurantList)
  ...
  render() {
    console.log(this.filteredRestaurantList)
    return (
      <>
